        ...
        <div className="bg-white p-8 rounded-xl shadow-xl w-full max-w-md border border-gray-200">
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 text-lg"
          ...
          <div className="flex gap-4 mt-6">
            ...
            <button
              ...
              className="flex-1 bg-primary hover:bg-primary-hover active:bg-primary-active text-white py-2 px-4 rounded-md transition-all duration-200 transform hover:scale-105 active:scale-95 hover:shadow-md font-medium"
            >
              Login
            </button>
          </div>
