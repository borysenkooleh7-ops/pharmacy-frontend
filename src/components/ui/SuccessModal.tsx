        ...
        <div className="p-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-medium text-blue-800">
                  {language === 'me'
                    ? `Automatsko preusmjeravanje za ${countdown} sekundi...`
                    : `Auto-redirecting in ${countdown} seconds...`
                  }
                </p>
                <p className="text-xs text-blue-600">
                  {language === 'me'
                    ? 'Možete otkazati klikom na dugme'
                    : 'You can cancel by clicking a button'
                  }
                </p>
              </div>
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            >
              ...
              {language === 'me' ? 'Idi na početnu' : 'Go to Home'}
            </button>
            ...
            >
              ...
              {language === 'me' ? 'Dodaj još' : 'Submit Again'}
            </button>
          </div>
        </div>
      </div>
